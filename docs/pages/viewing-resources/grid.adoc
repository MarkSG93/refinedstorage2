...
You can place the {doctitle} in any direction, but the {doctitle} does _not_ transmit a network signal in the direction it's facing.
...
- xref:../integrations/just-enough-items.adoc#_recipe_viewer_synchronization[Just Enough Items]
- xref:../integrations/roughly-enough-items.adoc#_recipe_viewer_synchronization[Roughly Enough Items]
- xref:../integrations/emi.adoc#_recipe_viewer_synchronization[EMI]
